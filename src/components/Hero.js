...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative bg-gray-900 text-white min-h-dvh w-screen flex flex-col px-4 sm:px-6 md:px-8 pt-12 lg:pt-0">
      ...
      <div id="hero-content" className="relative z-10 flex-1 flex flex-col justify-center items-center text-center">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="text-base md:text-xl text-gray-100 mt-8 flex flex-col md:flex-row flex-wrap justify-center gap-3 mb-4">
        ...
        <div className="relative z-10 w-full text-center items-center animate-bounce text-gray-300 py-4 lg:py-8 text-lg sm:text-xl">
